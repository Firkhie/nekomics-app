...
router.get('/comics/coverart/:comicId/:coverFileName', ComicController.fetchImages)
router.get('/comics/chapterpages/:chapterHash/:pageId', ComicController.fetchImages)
