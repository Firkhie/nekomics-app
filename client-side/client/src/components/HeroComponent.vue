<template>
  <div class="w-full max-w-screen-xl px-6 md:px-8 mx-auto">
...
export default {
  ...
  methods: {
    ...
    handleDragEnd() {
      ...
      this.$refs.heroCarouselItems.style.transform = `translateX(${
