<template>
  <main class="relative w-full max-w-screen-xl px-3 md:px-8 mx-auto text-white flex-grow">
    <section class="w-full">
      ...
      <div
        class="relative flex items-center justify-between gap-2 mt-3 lg:text-base md:text-sm text-xs z-30"
      >
        <div id="sort-by-btn" class="relative w-[220px] cursor-pointer group" @click="toggleSortBy">
          ...
          <ul
            id="sort-by-menu"
            class="absolute flex-col bg-[#333434] rounded-sm w-full cursor-pointer top-[50px] md:top-[59px] lg:top-[62px] left-0 hidden group-open:block"
          >
        ...
        <div class="flex gap-2 md:gap-3">
          <button>
            <i
              class="fa-solid fa-list px-4 md:px-5 py-3 md:py-4 bg-[#1E1F1F] hover:opacity-70 text-base md:text-lg lg:text-xl"
            ></i>
          </button>
          <button>
            <i
              class="fa-solid fa-grip px-4 md:px-5 py-3 md:py-4 bg-[#1E1F1F] hover:opacity-70 text-base md:text-lg lg:text-xl"
            ></i>
          </button>
        </div>
      </div>
      ...
      <div class="flex items-center justify-center mt-6 lg:text-base md:text-sm text-xs">
        <div class="flex items-center justify-center gap-2 flex-wrap">
          ...
          <button class="flex items-center justify-center p-3 sm:p-4 rounded-sm bg-white/40 h-10">
            {{ currentIndex + 1 }}
          </button>
          <button
